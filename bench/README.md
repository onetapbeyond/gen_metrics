...
When activated, significant runtime costs _may_ be incurred by the application being monitored if the rate of synchronous calls is high. What exactly do we mean by a high rate of synchronous calls? See the discussion of results for each of the following benchmark tests for details.
