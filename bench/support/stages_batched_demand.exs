defmodule TracedBatchedProducer do
  use GenStage
...
defmodule TracedBatchedConsumer do
  use GenStage
  ...
  def init(_) do
    {:consumer, nil, subscribe_to: [TracedBatchedProducer]}
  end
...
defmodule UntracedBatchedProducer do
  use GenStage
...
defmodule UntracedBatchedConsumer do
  use GenStage
  ...
  def init(_) do
    {:consumer, nil, subscribe_to: [UntracedBatchedProducer]}
  end
